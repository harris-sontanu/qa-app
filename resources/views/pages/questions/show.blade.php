        ...
        <div class="container mw-md">
            ...
            <div class="topic-post d-flex">
                <div class="flex-column me-4 text-center">
                    <a role="button" href="{{ route('questions.vote', $question->slug) }}" data-vote="1" class="question-vote vote-up" title="This Question is useful"><i class="icon-caret-up1"></i></a>
                    <strong class="d-block votes-count mb-4">{{ $question->votes_count }}</strong>
                    <a role="button" href="{{ route('questions.vote', $question->slug) }}" data-vote="-1" class="question-vote vote-down" title="This Question is not useful"><i class="icon-caret-down1"></i></a>
